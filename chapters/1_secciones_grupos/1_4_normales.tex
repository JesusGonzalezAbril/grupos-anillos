...
\begin{proofbox}
Veamos que (1) $\Leftrightarrow$ (2) $\Leftrightarrow$ (3) $\Leftrightarrow$ (4). En efecto, si se verifica (3) entonces para todo $x \in G$
\[
x^{-1}Nx \subseteq N, xNx^{-1} \subseteq Nx \iff xN \subseteq xN, xN \subseteq Nx \iff Nx = xN.
\]
Esto demuestra que las tres primeras propiedades son equivalentes y, por simetría, también la cuarta es equivalente a ellas.
