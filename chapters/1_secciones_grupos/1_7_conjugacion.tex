...
H_j = G_j / N
\]
para algún subgrupo normal $G_j$ de $G$, en concreto $G_k = N, G_n = G$. Por el Segundo Teorema de Isomorfía (\ref{thm:teoremas_isomorfia}) cada uno de estos grupos verifica $[G_j : G_{j-1}] = [H_j : H_{j-1}] = p$. Por tanto, la cadena de subgrupos
