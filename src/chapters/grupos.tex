...
\ex{
    Sea \(X\) un conjunto y consideremos la aplicación identidad $id: X \to X$ tal que $id(x) = x$ para todo $x \in X$. Entonces el conjunto $T = \{id\}$ con la operación de composición es un grupo $(T, \circ)$ que llamaremos el grupo trivial (lo denotaremos $1$).
